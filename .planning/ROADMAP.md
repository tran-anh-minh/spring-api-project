...
- [x] 05-02-PLAN.md — Background learning daemon scheduler (schedule library)
- [x] 05-03-PLAN.md — Cross-project pattern store, export, and reader
- [x] 05-04-PLAN.md — Multi-format export system (markdown, Mermaid, JSON, annotated DDL)
- [x] 05-05-PLAN.md — MCP manage tools and CLI commands (serve, status, export, daemon)
